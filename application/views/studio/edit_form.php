		...
		<div id="content-wrapper">
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<form action="<?php base_url('studio/edit') ?>" method="post" enctype="multipart/form-data" >
							<input type="hidden" name="id" value="<?php echo $studio->id_studio?>" />
							<div class="form-group">
								<label for="nama_studio">Nama Studio *</label>
								<input class="form-control <?php echo form_error('nama_studio') ? 'is-invalid':'' ?>"
								type="text" name="nama_studio" min="0" placeholder="Nama studio" value="<?php echo $studio->nama_studio ?>" />
