					...
					<div class="card-body">
						<form action="<?php base_url('jadwal/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								...
								<?php
								echo select_option('judul','tbl_film','judul','id_film',null,null,null,'<option>Pilih Film</option>');
								?>
							...
							<div class="form-group">
								...
								<?php
								echo select_option('studio','tbl_studio','nama_studio','id_studio',null,null,null,'<option>Pilih Studio</option>');
								?>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								type="date" name="tanggal_tayang" min="0" placeholder="Tanggal Tayang" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								type="time" name="jam_tayang" min="0" placeholder="Jam Tayang" />
								<div class="invalid-feedback">
